...
// ESP-IDF v5.x fix for missing GPIO_PIN_MUX_REG
/*
...
const uint32_t GPIO_PIN_MUX_REG[] = {
    ...
    0,                 IO_MUX_GPIO21_REG, IO_MUX_GPIO22_REG, IO_MUX_GPIO23_REG,
    0,                 IO_MUX_GPIO25_REG, IO_MUX_GPIO26_REG, IO_MUX_GPIO27_REG,
    0,                 0,                 0,                 0,
